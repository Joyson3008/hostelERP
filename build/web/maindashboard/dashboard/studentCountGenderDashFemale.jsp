<%-- 
    Document   : studentCountGenderDashFemale
    Created on : Sep 9, 2025, 11:18:44 AM
    Author     : rm
--%>
...
<div class="col-4">
    <h4 class="text-c-red"><%= StudentCountDAO.getcountgenderwise("ug_2025_student",officeid,"F") %></h4>
    <h6 class="text-muted m-b-0">2025</h6>
</div>
    
    <div class="col-4">
    <h4 class="text-c-red"><%= StudentCountDAO.getcountgenderwise("ug_2024_student",officeid,"F") %></h4>
    <h6 class="text-muted m-b-0">2024</h6>
</div>
    
    <div class="col-4">
    <h4 class="text-c-red"><%= StudentCountDAO.getcountgenderwise("ug_2023_student",officeid,"F") %></h4>
