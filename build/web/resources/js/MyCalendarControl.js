...
var dispalyMonthsandYears = "";
var displaymonths = ['January','February','March','April','May','June','July','August','September','October','November','December'];
...
function changeYearFromCombo(change) {
  ...
  function calendarDrawTable() {
    ...
    var alertmessage="";
    var table = "<table cellspacing='0' style='width:100%' cellpadding='0'>";
    ...
    //table = table + "  <td colspan='1' class='previous' nowrap style='height:10px'><a href='javascript:changeCalendarControlMonth(-1);'>&lt;</a> </td>";
    //table = table + "  <td colspan='5' class='previous' nowrap style='height:10px'></td>";

    //table = table + "  <td colspan='5' class='title' nowrap>" + drawMonths() + "&nbsp;" + drawYear() + "</td>";

    //table = table + "  <td colspan='1' class='next' nowrap style='height:10px'><a href='javascript:changeCalendarControlMonth(1);'>&gt;</a></td>";
    //table = table + "</tr>";
      ...
      for(var dayOfWeek=0; dayOfWeek < 7; dayOfWeek++) {
        ...
        if(validDay) {
          ...
          if (alertmessage=="empty"){
              ...
              table = table + "<td valign='top' onclick='funTdClick(this,event,"+dayOfMonth+","+currentMonth+","+currentYear+",\""+displaymonths[currentMonth - 1]+"\")'><a class='"+css_class+"'>"+dayOfMonth+"</a></td>";
          }else{
    ...
    table = table + "</table>";
    dispalyMonthsandYears.innerHTML = displaymonths[currentMonth - 1]+ " - " +currentYear;
    return table;
  }

  this.show = show;
  function show(field,field1,argDivName) {
    ...
    if(document.getElementById){
      ...
      var fieldPos = new positionInfo(argDivName);
    ...
    dispalyMonthsandYears.innerHTML = displaymonths[lcurrentMonth - 1]+ " - " +lcurrentYear;
    dateField.focus();
}
...
var calendarControl = new MyCalendarControl();
...
function showCalendarControl(objTextField,argPastDay,argCurrentDay,argFutureDay,argCurrentDate,objHidden,objDivName,objDisplayName){
  // textField.onblur = hideCalendarControl;
  futureAllowed=argFutureDay;
  pastAllowed=argPastDay;
  isCurrentDateAllow=argCurrentDay;
  dispalyMonthsandYears = objDisplayName;
  ...
  calendarControl.show(objTextField,objHidden,objDivName);
}
...
function showCalendarControlText(argTextObject,argPastDay,argCurrentDay,argFutureDay,argCurrentDate,argHiddenObject){
    ...
    if (!argTextObject.disabled){
        ...
        if (result != "empty"){
            ...
            setTimeout(function(){argTextObject.focus();},1);
        }
    }
}
