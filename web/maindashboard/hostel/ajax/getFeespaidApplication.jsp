<%-- 
    Document   : getFeespaidApplication
    Created on : Apr 14, 2026, 10:39:12 AM
    Author     : lccerp26
--%>
...
<%
    try {
        ...
        JSONArray arr = ERPHostelDAO.getNonSelectedApplicants(fromDate, toDate, institution, academicyear, office);
        ...
        System.out.println("\n\n\nCatch in getFeespaidApplication.jsp\n\n\n");
        e.printStackTrace();
