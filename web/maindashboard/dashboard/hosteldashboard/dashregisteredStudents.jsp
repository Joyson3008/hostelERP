<%-- 
    Document   : dashregisteredStudents
    Created on : Apr 28, 2026, 10:34:24?AM
    Author     : lccerp26
--%>
...
<%
    String per = "A";
    String mName = "DASH_REGISTERED_STUDENTS";
%>
...
<script>
    ...
    function loadStudents() {
        ...
        $.ajax({
            url: "ajax/getRegisteredStudents.jsp",
            type: "GET",
            dataType: "json",
    ...
    function viewStudent(regno) {
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                html += "</div>";
                html += "<div class='row mt-2'>";
                html += "<div class='col-md-12'><b>Permanent Address:</b> " +
                        res.address_line1 + " " +
                        res.address_line2 + " " +
