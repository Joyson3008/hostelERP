...
<div class="col-4">
    <h4 class="text-c-red"><%= StudentCountDAO.getCount("ug_2025_student",officeid) %></h4>
    <h6 class="text-muted m-b-0">2025</h6>
</div>
    
    <div class="col-4">
    <h4 class="text-c-red"><%= StudentCountDAO.getCount("ug_2024_student",officeid) %></h4>
    <h6 class="text-muted m-b-0">2024</h6>
</div>
    
    <div class="col-4">
    <h4 class="text-c-red"><%= StudentCountDAO.getCount("ug_2023_student",officeid) %></h4>
